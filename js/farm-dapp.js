        ...
        if(_this.lastNftIndex == -1) {
            ...
            try {
                ...
                if (typeof data == 'object') {
                    ...
                    farm_image = typeof data.image != 'undefined' && data.image ? data.image.replace('ipfs://', 'https://dweb.link/ipfs/').replace('/ipfs/ipfs/', '/ipfs/') : '';
        ...
        try {
            ...
            if (typeof data == 'object') {
                ...
                if(typeof data.image != "undefined" && data.image != '') {
                    image = '<img src="' + data.image.replace('ipfs://','https://dweb.link/ipfs/').replace('/ipfs/ipfs/', '/ipfs/') + '" border="0" style="width: 25px;" />';
                }
            }
